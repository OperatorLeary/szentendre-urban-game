...
export const MIN_LOCATION_INSTRUCTION_BRIEF_LENGTH = 5;
export const MAX_LOCATION_INSTRUCTION_BRIEF_LENGTH = 2_000;
export const MIN_LOCATION_INSTRUCTION_FULL_LENGTH = 10;
export const MAX_LOCATION_INSTRUCTION_FULL_LENGTH = 20_000;
